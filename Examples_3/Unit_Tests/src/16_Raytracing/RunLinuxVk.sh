...
export VK_LAYER_PATH=../../../../Common_3/Graphics/ThirdParty/OpenSource/VulkanSDK/bin/Linux/
export LD_LIBRARY_PATH=../../../../Common_3/Graphics/ThirdParty/OpenSource/VulkanSDK/bin/Linux/:$LD_LIBRARY_PATH
